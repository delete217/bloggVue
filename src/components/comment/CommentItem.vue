<template>
  <div class="me-view-comment-item">
    <div class="me-view-comment-author">
      <a class="">
        <img class="me-view-picture" :src="comment.userVo.avatar"></img>
      </a>
      <div class="me-view-info">
        <span class="me-view-nickname">{{comment.userVo.nickname}}</span>
    ...
    <div>
      <p class="me-view-comment-content">{{comment.content}}1222</p>
      <div class="me-view-comment-tools">
        <!--<a class="me-view-comment-tool">-->
        <!--<i class="el-icon-caret-top"></i> 20-->
        <!--</a>-->
        <a class="me-view-comment-tool" @click="showComment(-1,comment.userVo)">
      ...
      <div class="me-reply-list">
        <div class="me-reply-item" v-for="c in comment.childrens" :key="c.id">
          <div style="font-size: 14px">
            <span class="me-reply-user">{{c.userVo.nickname}}:&nbsp;&nbsp;</span>
